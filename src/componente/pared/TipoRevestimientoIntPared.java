...
public enum TipoRevestimientoIntPared {
	...
	ESTUCO_VENECIANO("estuco veneciano",3), VINILICOS("vinilicos",4),MICROCEMENTO("microcemento",1), 
	VENECITAS("venecitas",2), ESMALTADO("esmaltado",3), REVOQUE("revoque",4),MADERA("madera",1), 
	CERAMICA("ceramica",2),HORMIGON_PULIDO("hormigon pulido",3), PIEDRA_NATURAL("piedra natural",4),
